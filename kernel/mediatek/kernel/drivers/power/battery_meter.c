...
#ifdef LENOVO_CHARGING_STANDARD_SUPPORT
...
/*lenovo-sw zhangrc2 optim charge code  end 2014-08-19 */ 
 ...
 /*lenovo-sw zhangrc2 optim charge code  end 2014-08-19 */     
	...
	/*lenovo-sw zhangrc2 optim charge code  begin 2014-08-19 */ 
     ...
     //    if( ( (g_rtc_fg_soc != 0) &&(g_rtc_fg_soc != 1) && ( ( (abs(g_rtc_fg_soc-gFG_capacity_by_v) ) <= CUST_POWERON_DELTA_CAPACITY_TOLRANCE) ) || (abs(gFG_capacity_by_v_init - g_rtc_fg_soc) < abs(gFG_capacity_by_v - gFG_capacity_by_v_init)))
...
/*lenovo-sw zhangrc2 update get current function 2014-08-27 */
...
/*lenovo-sw zhangrc2 update get current function  end 2014-08-27 */
