...
///////////////////////////////////////////////////////////////////////////////////////////
/* lenovo-sw zhangrc2 open total charging time  protect 2014-10-26 */
...
#if defined(LENOVO_CHARGING_STANDARD_SUPPORT) 	
...
static void mt_battery_CheckBatteryStatus(void)
{
 ...
 #ifndef LENOVO_CHARGING_STANDARD_SUPPORT
...
#else
	battery_charging_control(CHARGING_CMD_GET_CHARGER_TYPE,&CHR_Type_num);
       /* lenovo-sw zhangrc2  detect charge type again when type is non-standard type */
