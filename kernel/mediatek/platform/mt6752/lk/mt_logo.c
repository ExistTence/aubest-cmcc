...
/*lenovo_sw liaohj add 2014-07-11 ---begin */
//#include <cust_display.h>
#include <target/cust_display.h>
#include <platform/mt_reg_base.h>
#include <platform/boot_mode.h>
/*lenovo_sw liaohj add 2014-07-11 ---end */
...
/*lenovo-sw chuyq 2014.4.22 add begin*/
        ...
        fill_animation_logo(39, mt_get_fb_addr(), (void *)mt_get_tempfb_addr(), logo_addr, phical_screen);
        else if(g_boot_mode == META_BOOT)
        fill_animation_logo(40, mt_get_fb_addr(), (void *)mt_get_tempfb_addr(), logo_addr, phical_screen);
        else
