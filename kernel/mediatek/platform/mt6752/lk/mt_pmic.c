...
U32 pmic_init (void)
{
    ...
    /*lenovo sw linrq1 20140804 add vibrate on boot begin*/
    mt6325_upmu_set_rg_vibr_vosel(0x7);
    mt6325_upmu_set_rg_vibr_sw_mode(0);
    mt6325_upmu_set_rg_vibr_fr_ori(1);
    mt6325_upmu_set_rg_vibr_en(1);
    udelay(100000);//vibrate 100ms
    mt6325_upmu_set_rg_vibr_en(0);
    /*lenovo sw linrq1 20140804 add vibrate on boot end*/
