...
int CamPathPass1::setP1RrzCfg(IspRrzCfg const rrz_cfg)
{
    ...
    if ( rrz_cfg.isTwinMode || (ISP_PASS1 == rrz_cfg.pass1_path) ) {
        ...
        DMARrzo.dma_cfg.crop.w = 0; //no used on ROME
        DMARrzo.dma_cfg.crop.h = 0; //no used on ROME
        ...
        DMARrzo_d.dma_cfg.crop.w = 0; //no used on ROME
        DMARrzo_d.dma_cfg.crop.h = 0; //no used on ROME
