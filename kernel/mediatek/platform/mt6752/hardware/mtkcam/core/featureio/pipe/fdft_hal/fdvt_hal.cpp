...
//lenovo-sw, qiujz1 2014-07-30, add
/*******************************************************************************
  * lenovo-sw, yuqing1 add, 2014/06/12
  * For face detect function using a lower threshold for higher sensitivity.
  * This is corresbonding to CAMERA_FACE_DETECTION_LOWTHRESHOLD define in Camera.java.
********************************************************************************/
#define FDTHRESHOLD_MODE_LOW    2
...
//**********************************************************************//        
    ...
    FDFTInitInfo.FDTBufWidth = image_width_array[0];// µ¹OT¥Î??, 320x240
    ...
    //lenovo-sw, qiujz1 2014-07-30, add
    /*lenovo-sw, yuqing1 add, 2014/06/12, For face detect function using a lower threshold for higher sensitivity, Begin*/
    /*
    if (FDThresholdMode == FDTHRESHOLD_MODE_LOW) {
        MY_LOGD("Face Detection low-threshold running, FDThreshold will be set to 30 for higher sensitivity!!");
        FDFTInitInfo.FDThreshold = 30;
    }*/
    /*lenovo-sw, yuqing1 add, 2014/06/12, For face detect function using a lower threshold for higher sensitivity, End*/
