...
//songwei add for flash mode error.
...
{ 
	...
	MY_LOG("[%s()] m_BVvalueWOStrobe:%d bEV0TriggerStrobe:%d\n", __FUNCTION__, m_eSensorDev, m_BVvalueWOStrobe, m_rAEInitInput.rAEPARAM.strAEParasetting.bEV0TriggerStrobe); 
	if(m_rAEInitInput.rAEPARAM.strAEParasetting.bEV0TriggerStrobe == MTRUE) { // The strobe trigger by the EV 0 index 
		...
		//if(m_rAEInitInput.rAEPARAM.pEVValueArray[m_eAEEVcomp]) { 
        	if(m_rAEInitInput.rAEPARAM.pEVValueArray && m_rAEInitInput.rAEPARAM.pEVValueArray[m_eAEEVcomp]) {
			MY_LOG("[%s()] m_eAEEVcomp:%d \n", __FUNCTION__, m_eSensorDev, m_eAEEVcomp); 
			if(m_pIAeAlgo != NULL) { 
...
//songwei add for flash mode error end
#if 0
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL AeMgr::IsStrobeBVTrigger()
{
    ...
    if(m_rAEInitInput.rAEPARAM.strAEParasetting.bEV0TriggerStrobe == MTRUE) {         // The strobe trigger by the EV 0 index
        ...
        //if(m_rAEInitInput.rAEPARAM.pEVValueArray[m_eAEEVcomp]) {
	//songwei change for takepicture NE aee_exp 2014-8-7
        if(m_rAEInitInput.rAEPARAM.pEVValueArray && m_rAEInitInput.rAEPARAM.pEVValueArray[m_eAEEVcomp]) {
            if(m_pIAeAlgo != NULL) {
                i4Bv = m_BVvalueWOStrobe - m_pIAeAlgo->getSenstivityDeltaIndex(1024 *1024/ m_rAEInitInput.rAEPARAM.pEVValueArray[m_eAEEVcomp]);
            } else {
