...
FeaturePipeFdNode*
FeaturePipeFdNode::createInstance(MUINT32 featureOnMask, FeaturePipe* pFeaturePipeObj)
{
    LOG_AST(featureOnMask & FEATURE_ON_MASK_BIT_VFB, "Create FD node while vFB is off", 0);
    return new FeaturePipeFdNode("FeaturePipeFdNode", SingleTrigger, SCHED_POLICY, SCHED_PRIORITY, featureOnMask, pFeaturePipeObj);
}
MVOID
