...
getPass2Buffer(vector<p2data>& vP2data)
{
    ...
    //songwei add for front camera capture mirror mode 2014-8-8.
    if( one.vDstReq[0].mTransform == eTransform_ROT_90 ||
    one.vDstReq[0].mTransform == eTransform_ROT_270 ||
    one.vDstReq[0].mTransform == (eTransform_FLIP_H|eTransform_ROT_90)||
    one.vDstReq[0].mTransform == (eTransform_FLIP_V|eTransform_ROT_90) )
    //songwei add for front camera capture mirror mode 2014-8-8 end.
