...
getPass2Buffer(vector<p2data>& vP2data)
{
    ...
    // dst
    {
		...
		//songwei add for front camera caputre mirror mode
		if( pData->vDstReq[0].mTransform == eTransform_ROT_90 ||
		    	    pData->vDstReq[0].mTransform == eTransform_ROT_270 ||
		    	    pData->vDstReq[0].mTransform == (eTransform_FLIP_H|eTransform_ROT_90)||
		    	    pData->vDstReq[0].mTransform == (eTransform_FLIP_V|eTransform_ROT_90) )
		        //songwei add for front camera caputre mirror mode end.
