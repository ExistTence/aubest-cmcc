...
{ 
    ...
    CAM_LOGE("----%d---[%s-%d-%d]\n",mShotParam.mu4Transform,mShotParam.ms8SnapShotFilp.string(),mShotParam.mi4PostviewWidth,mShotParam.mi4PostviewHeight);
    if(::strcmp(mShotParam.ms8SnapShotFilp,"on")==0)
    { 
	    if(getOpenId() == 1){
