...
onHandleStartRecording()
{
    ...
    {
        mpDefaultBufHdl->mapPort(DefaultBufHandler::eBuf_Rec, PASS2_PRV_DST_3, MTRUE);
        //
    ...
    else
    {
        if(mbTwoRunP2)
        {
            mpDefaultBufHdl->mapPort(DefaultBufHandler::eBuf_Rec, TRANSFORM_DST_1, MTRUE);
        }
        else
        {
            mpDefaultBufHdl->mapPort(DefaultBufHandler::eBuf_Rec, PASS2_PRV_DST_1, MTRUE);
        }
        //
        mpPass2Node->startRecording(
                        vdoWidth,
