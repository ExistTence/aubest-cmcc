      ...
      , MUINT32 & u4JpegSize)
{
    ...
    CAM_LOGE("-------[%s]\n",mShotParam.ms8SnapShotFilp.string());
    if((getOpenId() == 1)&&(::strcmp(mShotParam.ms8SnapShotFilp,"on")==0)){
...
createJpegImgWithThumbnail(IImageBuffer const *rYuvImgBufInfo, IImageBuffer const *rPostViewBufInfo, MUINT32 const Mode)
{
    ...
    handleJpegData((MUINT8*)jpegBuf->getBufVA(0), jpegBuf->getBufSizeInBytes(0), (MUINT8*)thumbBuf->getBufVA(0), thumbBuf->getBufSizeInBytes(0), Mode);
