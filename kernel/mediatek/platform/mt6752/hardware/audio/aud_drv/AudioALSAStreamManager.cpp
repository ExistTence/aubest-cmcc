...
void AudioALSAStreamManager::setLeaveWayMode(bool bIsLeaveWayOn)
{
    ALOGD("%s(), bIsLeaveWayOn = %d", __FUNCTION__, bIsLeaveWayOn);
    mLeaveWayOn = bIsLeaveWayOn;
//    return NULL;
}

bool AudioALSAStreamManager::getLeaveWayMode(void)
{
    ALOGD("%s(), mLeaveWayOn = %d", __FUNCTION__, mLeaveWayOn);
    return mLeaveWayOn;
}
    ...
    stream_attribute_t *stream_attribute_source)
{
    ...
    {
     /*lenovo-sw fuxm1 2014-07-13 add for leaveway mode begain*/
        //chris add for call leave way to receive the value to mLeaveWayOn
        getLeaveWayMode();
     /*lenovo-sw fuxm1 2014-07-13 add for leaveway mode end*/
