...
#### lenovo-sw zhouwl,2014-08-28,add for aio begin ######
ifeq ($(strip $(NXP_SMARTPA_SUPPORT)),tfa9897)
    LOCAL_CFLAGS += -DNXP_SMARTPA_SUPPORT
    LOCAL_CFLAGS += -DNXP_SMARTPA_SUPPORT_TFA9897
    LOCAL_CFLAGS += -DEXT_SPK_SUPPORT
    LOCAL_SRC_FILES += $(LOCAL_COMMON_PATH)/hardware/audio/V3/aud_drv/AudioALSACodecDeviceOutSpeakerNXP.cpp
#    LOCAL_C_INCLUDES += $(MTK_PATH_SOURCE)/external/nxp
#    LOCAL_SHARED_LIBRARIES += libtfa9897_interface
endif
#### lenovo-sw zhouwl,2014-08-28,add for aio end ######
