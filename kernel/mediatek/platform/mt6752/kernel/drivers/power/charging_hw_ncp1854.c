...
//  ncp1854_set_int_mask(0x0); //disable all interrupt
   ...
   /* lenovo-sw zhangrc2  change cv setting 2014-08-27 begin */
    ...
    if((ncp1854_status == 0x8) || (ncp1854_status == 0x9) || (ncp1854_status == 0xA)) //WEAK WAIT, WEAK SAFE, WEAK CHARGE
       ...
       /*lenovo sw zhangrc2 set cv 4.45V at init fuction begin*/ 				
        ncp1854_set_ctrl_vbat(0x2A) ; //VCHG = 4.3V to decrease charge time
    else
        ncp1854_set_ctrl_vbat(0x2A); //VCHG = 4.2V
      /*lenovo sw zhangrc2 set cv 4.45V at init fuction end */ 	
   #endif	  
    /* lenovo-sw zhangrc2  change cv setting 2014-08-27 begin */	
...
/*lenovo-sw zhangrc2 open feature HIGH_BATTERY_VOLTAGE_SUPPORT  begin 2014-07-15 */
#ifdef HIGH_BATTERY_VOLTAGE_SUPPORT
...
#endif
#endif
/*lenovo-sw zhangrc2 open feature HIGH_BATTERY_VOLTAGE_SUPPORT  end 2014-07-15 */
	return status;
 } 	
 ...
 static kal_uint32 charging_set_input_current(void *data)
 {
	...
	if (current_value < 60000)
	{
	    ...
	    /* lenovo-sw zhangrc2 set input current equal to charge current 2014-01-12 begin */
	    register_value +=1; 	
	    /* lenovo-sw zhangrc2 set input current equal to charge current 2014-01-12 end */		
...
void kick_charger_wdt(void)
{
 ...
 {
		 kal_uint32 status = STATUS_OK;
  /* lenovo-sw zhangrc2 check battery status again when check battery is not exist 2014-11-20 */		 
	          kal_uint32 val = 0;
#if defined(CONFIG_POWER_EXT) || defined(CONFIG_MTK_FPGA)
