...
//Lenovo-sw wuwl10 add 20140901 for esd 
static bool esd_recover_panel_backlight = false;
...
int disp_lcm_init(disp_lcm_handle *plcm, int force)
{
	...
	if(_is_lcm_inited(plcm))
	{
		...
		//Lenovo-sw wuwl10 add 20140901 for esd to recover backlight begin
		if (esd_recover_panel_backlight)
		{
		...
		{
			esd_recover_panel_backlight = true;
		}
		//Lenovo-sw wuwl10 add 20140901 for esd to recover backlight end
