...
int ddp_dsi_build_cmdq(DISP_MODULE_ENUM module, void *cmdq_trigger_handle, CMDQ_STATE state)
{
	...
	DSI_T0_INS t0;
//Lenovo-sw wuwl10 modify 20141022 to support esd read longpackage begin
	DSI_T0_INS t1;
...
//Lenovo-sw wuwl10 modify 20141022 to support esd read longpackage end
...
//Lenovo-sw wuwl10 modify 20141022 to support esd read longpackage begin
			...
			DISPCHECK("[DSI]enter cmp read_data1=0x%x\n",read_data1);
			DISPCHECK("[DSI]enter cmp read_data2=0x%x\n",read_data2);
			DISPCHECK("[DSI]enter cmp read_data3=0x%x\n",read_data3);
//Lenovo-sw wuwl10 modify 20141022 to support esd read longpackage end
