...
/* lenovo-sw zhangrc2 change pa mode 2014-08-13 begin */
...
#define AW8736_MODE4 /*it depends on THD, range: 1.5 ~ 2.0w*/ \
    ...
    mt_set_gpio_out(GPIO_EXT_SPKAMP_EN_PIN,GPIO_OUT_ONE);
#endif
/* lenovo-sw zhangrc2 change pa mode 2014-08-13 end */

static void Ext_Speaker_Amp_Change(bool enable)
{
/* lenovo-sw zhangrc2 resolve pop problem when use spaker begin */
#define SPK_WARM_UP_TIME        (45) //unit is ms
/* lenovo-sw zhangrc2 resolve pop problem when use spaker end */
    if (enable)
    {
